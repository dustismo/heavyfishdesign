...
// key ordering.  Originally
// from https://github.com/iancoleman/orderedmap
...
func NewOrderedMapFromMap(mp map[string]interface{}) *OrderedMap {
	o := OrderedMap{}
